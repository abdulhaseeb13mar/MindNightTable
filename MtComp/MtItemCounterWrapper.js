...
import {H_W} from './MtDim';
import Feather from 'react-native-vector-icons/Feather';
import {useSafeAreaInsets} from 'react-native-safe-area-context';
import {MtaddCartAction, MtremoveCartAction} from '../MtRedux/MtActions';
    ...
    <View
      ...
      {(position === 'top' || position === 'left') && (
        <DefaultCounter
          position={position}
          item={props.item}
          MtGoToSingleProduct={props.MtGoToSingleProduct}
          MtaddCart={(i) => props.MtaddCartAction(i)}
          MtremoveCart={(i) => props.MtremoveCartAction(i)}
  ...
  return (
    <View
      ...
      <View
        ...
        <TouchableOpacity onPress={() => MtremoveCart(item)}>
          <Feather
            name="minus-circle"
            size={H_W.width * 0.05}
            color={'black'}
        ...
        <TouchableOpacity onPress={() => MtaddCart(item)}>
...
export default connect(null, {MtaddCartAction, MtremoveCartAction})(
  ItemCounterWrapper,
);
