...
function SingleProduct(props) {
  ...
  const fetchFlavours = () => {
    ...
    for (let ce = 0; ce < Data.topping.length; ce++) {
      if (Data.topping[ce].productid === MtProduct.id) {
        ...
        <View
          ...
          <View style={styles.singleProduct_CE15}>
            <View style={{marginTop: -HEIGHT * 0.04}}>
              {props.MtCart[`${MtProduct.id}_${CurrFlavours.topping}`] !==
                undefined &&
              props.MtCart[`${MtProduct.id}_${CurrFlavours.topping}`] !== 0 ? (
                <View style={styles.singleProduct_CE2}>
                  <TouchableOpacity
                    style={{...styles.singleProduct_CE5, height: HEIGHT * 0.05}}
                    onPress={MtRemoveFromCart}>
                    <Entypo
                      name="minus"
                      color="black"
            ...
            <Text style={styles.singleProduct_CE11}>${MtProduct.price}</Text>
          </View>
          <View
          ...
          <View style={{marginBottom: '10%'}}>
            <Text style={styles.singleProduct_CE13}>{MtProduct.details}</Text>
          </View>
        </View>
      </View>
    </WrapperScreen>
