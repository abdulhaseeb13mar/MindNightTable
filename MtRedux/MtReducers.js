...
const MtCartReducer = (st = cart, action) => {
...
const MtUserReducer = (st = userState, action) => {
  switch (action.type) {
...
const MtCrntPrdtReducer = (state = crntPrdtState, action) => {
  switch (action.type) {
...
const MtToggleFav = (state = FavItems, action) => {
  switch (action.type) {
